                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              16.0, 4.0, 0.0, 0.0),
                          child: Text(
                            'Abaixo estão alguns alertas para você.',
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Inter',
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'A tarefa está próxima de expirar',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyLarge
                                                          .override(
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Por favor, não confie em Denner.',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Almoço executivo com tudo pago',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyLarge
                                                          .override(
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Não chamem Lucien, senão não sobra comida!',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
