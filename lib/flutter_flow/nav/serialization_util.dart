  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case OrdemServicoRow:
            return OrdemServicoRow(data);
          case AuditoriaTecnicoRow:
            return AuditoriaTecnicoRow(data);
          case TipoOsRow:
            return TipoOsRow(data);
          case UsoVeiculoRow:
            return UsoVeiculoRow(data);
          case AvaliacaoOsRow:
            return AvaliacaoOsRow(data);
          case FuncaoRow:
            return FuncaoRow(data);
          case EtapaOsRow:
            return EtapaOsRow(data);
          case UsuarioRow:
            return UsuarioRow(data);
          case PermissoesRow:
            return PermissoesRow(data);
          case PermissoesFuncoesRow:
            return PermissoesFuncoesRow(data);
          case EntradaDadosRow:
            return EntradaDadosRow(data);
          case DadosRow:
            return DadosRow(data);
          case ClienteRow:
