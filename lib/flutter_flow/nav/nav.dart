...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'OrdemServico',
          path: '/ordemServico',
          builder: (context, params) => OrdemServicoWidget(
            idordem: params.getParam(
              'idordem',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'HomeListOsTeste',
          path: '/homeListOsTeste',
          builder: (context, params) => const HomeListOsTesteWidget(),
        ),
        FFRoute(
          name: 'teste',
          path: '/teste',
