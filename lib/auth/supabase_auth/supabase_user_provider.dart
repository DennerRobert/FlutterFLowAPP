...
class SuperAppEvosSupabaseUser extends BaseAuthUser {
  SuperAppEvosSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> superAppEvosSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SuperAppEvosSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
